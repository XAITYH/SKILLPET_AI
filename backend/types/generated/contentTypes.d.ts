...
export interface ApiAppUserAppUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    authProviders: Schema.Attribute.JSON;
    avatarUrl: Schema.Attribute.String;
    characterFileName: Schema.Attribute.String;
    ...
    insforgeUserId: Schema.Attribute.String & Schema.Attribute.Unique;
    lastAuthenticatedAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiChapterContentBlockChapterContentBlock
  extends Struct.CollectionTypeSchema {
  collectionName: 'chapter_content_blocks';
  info: {
    description: 'Interactive learning content blocks within a chapter';
    displayName: 'Chapter Content Block';
    pluralName: 'chapter-content-blocks';
    singularName: 'chapter-content-block';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::chapter-content-block.chapter-content-block'
    > &
      Schema.Attribute.Private;
...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Chapters within a course';
    displayName: 'Chapter';
    pluralName: 'chapters';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Learning courses available in the app';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiUserCourseProgramUserCourseProgram
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_course_programs';
  info: {
    description: 'Tracks user progress in courses';
    displayName: 'User Course Program';
    pluralName: 'user-course-programs';
    singularName: 'user-course-program';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    appUser: Schema.Attribute.Relation<'manyToOne', 'api::app-user.app-user'>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-course-program.user-course-program'
    > &
      Schema.Attribute.Private;
...
export interface ApiUserProgressUserProgress
  ...
  attributes: {
    ...
    completedChapters: Schema.Attribute.JSON;
    ...
    lastStreak: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-progress.user-progress'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    streakDays: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::chapter-content-block.chapter-content-block': ApiChapterContentBlockChapterContentBlock;
      'api::chapter.chapter': ApiChapterChapter;
      'api::course.course': ApiCourseCourse;
      'api::user-course-program.user-course-program': ApiUserCourseProgramUserCourseProgram;
